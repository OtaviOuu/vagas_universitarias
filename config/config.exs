...
config :vagas_universitarias, VagasUniversitariasWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: VagasUniversitariasWeb.ErrorHTML, json: VagasUniversitariasWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: VagasUniversitarias.PubSub,
  live_view: [signing_salt: "Dv9XxgoQ"]
